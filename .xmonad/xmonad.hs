...
--
myNormalBorderColor  = "#000000" -- "#dddddd"
myFocusedBorderColor = "#ffa500" -- "#ff0000"
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
	...
	, ((modm , xK_Print ), spawn "scrot ~/screenshots/screen_%d-%m-%Y_%H-%M-%S.png -d 1")
	
	-- Take a screenshot of the focused window
	, ((modm .|. controlMask, xK_Print ), spawn "scrot ~/screenshots/window_%d-%m-%Y_%H-%M-%S.png -d 1-u")
